...
contract NodeDriver is Initializable {
    ...
    function swapCode(address acc, address withAddr) external onlyBackend {
        evmWriter.swapCode(acc, withAddr);
    }
...
interface EVMWriter {
    ...
    function swapCode(address acc, address withAddr) external;
